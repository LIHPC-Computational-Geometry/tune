...
def train():
    ...
    dataset = [TM.random_mesh(12) for _ in range(9)]
    plot_dataset(dataset)

    env = TriMesh(None, mesh_size, max_steps=15, feat=feature)
    ...
    model = PPO(env, lr, gamma, nb_iterations=3, nb_episodes_per_iteration=100, nb_epochs=3, batch_size=8)
    ...
    avg_steps, avg_wins, avg_rewards, final_meshes = testPolicy(actor, 5, dataset, 15)
