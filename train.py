...
def train():
    ...
    model = PPO(env, lr, gamma, nb_iterations=10, nb_episodes_per_iteration=100, nb_epochs=3, batch_size=8)
    ...
    avg_steps, avg_wins, avg_rewards, final_meshes = testPolicy(actor, 5, dataset, 40)
