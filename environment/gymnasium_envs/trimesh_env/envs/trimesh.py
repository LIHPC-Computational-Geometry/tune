...
from environment.gymnasium_envs.trimesh_env.envs.mesh_conv import get_x_level_2
...
class TriMeshEnv(gym.Env):
    ...
    def __init__(self, mesh=None, mesh_size=12, render_mode=None, size=5):
        ...
        self.n_actions = 5 # actions restricted to 5 darts
